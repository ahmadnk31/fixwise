...
async function GET(request) {
    ...
    try {
        let query = supabase.from("shop_products").select("*").order("created_at", {
            ascending: false
        });
        if (shopId) {
...
async function POST(request) {
    ...
    try {
        ...
        if (image && image.size > 0) {
            const blob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$vercel$2b$blob$40$2$2e$0$2e$0$2f$node_modules$2f40$vercel$2f$blob$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["put"])(image.name, image, {
                access: "public"
            });
            imageUrl = blob.url;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b67b492d._.js.map